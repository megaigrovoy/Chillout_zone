        ...
        <div className="overlay">
          <div className="panel">
            ...
            <p className="lead">
              ...
              спирали из Apophysis. Форма пересобирается движением вашей руки в реальном
              времени. Разрешите доступ к камере и поднимите ладонь перед собой.
            </p>

            <ul className="hints">
              <li>Раскрытая ладонь — спираль раскрывается шире</li>
              <li>Сжатый кулак — тугая плотная спираль</li>
              <li>Поворот кисти вращает всю фигуру</li>
              <li>Опустите руку — на ветвях появляется мелкое кружево</li>
              <li>Двигайте рукой вбок — меняется палитра</li>

 ...
 * objects to collide, so real physics needs a particle simulation. The mode is
 * chosen before starting and fixed for the session, which keeps each renderer
 * owning its own canvas and lifecycle.
 */
      ...
      {status.kind !== 'running' && (
        <div className="overlay">
          <div className="panel">
            <h1>Chillout Zone</h1>
            <p className="lead">
              Два визуальных движка, управляемых руками через веб-камеру.
            ...
            <ul className="hints">
              {mode === 'flame' ? (
                ...
                <>
                  <li>Раскройте ладонь — из неё пойдёт краска</li>
                  <li>Сожмите кулак — краска перестаёт выходить</li>
                  <li>Ведите рукой — краска тянется за кистью</li>
                  <li>Две руки — два цвета, которые смешиваются при встрече</li>
                </>
              )}
            </ul>
